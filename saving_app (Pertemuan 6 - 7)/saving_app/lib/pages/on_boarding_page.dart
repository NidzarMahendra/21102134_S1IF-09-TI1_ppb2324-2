    ...
    return Scaffold(
      body: Container(
        decoration: BoxDecoration(
          color: kBgColor.withOpacity(0.5), // Ganti dengan warna yang diinginkan
        ),
        width: double.infinity, // Mengisi lebar secara maksimum
        height: double.infinity, // Mengisi tinggi secara maksimum
        child: Column(
          children: [
            SafeArea(
              child: Image(
